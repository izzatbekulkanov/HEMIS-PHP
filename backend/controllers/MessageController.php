...
class MessageController extends BackendController
{
    ...
    public function actionAllMessages($id = false)
    {
        if ($id) {
            if ($model = $this->findMessageModel($id)) {
    ...
    public function actionCompose($id = false)
    {
        ...
        if ($id) {
            ...
            if ($model = AdminMessage::createDraftMessage($user)) {
                return $this->redirect(['compose', 'id' => $model->id]);
            }
     ...
     */
    protected function findMessageModel($id, Admin $admin = null)
    {
     ...
     * @throws NotFoundHttpException
     */
    protected function findMessageModelItem($id, Admin $admin)
    {
        /**
