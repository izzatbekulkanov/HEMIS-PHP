...
/* @var $model \common\models\student\EStudentExchange */

$this->title = $model->isNewRecord ? __('Insert Student Exchange') : $model->full_name;
$this->params['breadcrumbs'][] = ['url' => ['student/exchange'], 'label' => __('Student Exchange')];
    ...
    <div class="col col-md-12">
        ...
        <div class="box box-default ">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <?= $form->field($model, 'exchange_type')->widget(Select2Default::classname(), [
                            'data' => \common\models\student\EStudentExchange::getExchangeTypeOptions(),
                            'allowClear' => false,
                        ]) ?>
                    </div>
                    <div class="col-md-8">
                        <?= $form->field($model, 'exchange_document')->textInput(['maxlength' => true]) ?>
                    </div>
                </div>
            ...
            <div class="box-footer text-right">
                <?php if (!$model->isNewRecord): ?>
                    <?= $this->getResourceLink(__('Delete'), ['student/exchange', 'id' => $model->id, 'delete' => 1], ['class' => 'btn btn-danger btn-flat btn-delete', 'data-pjax' => 0]) ?>
                <?php endif; ?>
