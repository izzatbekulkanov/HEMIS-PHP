...
$this->title = $model->isNewRecord ? __('Insert Student Sport') : $model->student->getFullName();
$this->params['breadcrumbs'][] = ['url' => ['student/sport'], 'label' => __('Student Sport')];
    ...
    <div class="col col-md-12">
        <div class="box box-default ">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <?= $form->field($model, '_sport_type')->widget(Select2Default::classname(), [
                    ...
                    <div class="col-md-3">
                        <?= $form->field($model, 'sport_date')->widget(DatePickerDefault::classname(), [
                            'options' => [
                    ...
                    <div class="col-md-3">
                        <?= $form->field($model, 'sport_rank')->textInput(['maxlength' => true]) ?>
                    </div>
                    <div class="col-md-3">
                        <?= $form->field($model, 'sport_rank_document')->textInput(['maxlength' => true]) ?>
                    </div>
                </div>
            </div>
            <div class="box-footer text-right">
                <?php if (!$model->isNewRecord): ?>
                    <?= $this->getResourceLink(__('Delete'), ['student/sport', 'id' => $model->id, 'delete' => 1], ['class' => 'btn btn-danger btn-flat btn-delete', 'data-pjax' => 0]) ?>
                <?php endif; ?>
