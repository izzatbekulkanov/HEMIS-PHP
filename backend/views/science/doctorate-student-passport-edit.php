...
$this->title = __('Edit Passport Data');
$this->params['breadcrumbs'][] = ['url' => ['science/doctorate-student'], 'label' => __('Doctorate Student')];
$this->params['breadcrumbs'][] = ['url' => ['science/doctorate-student', 'id' => $model->id], 'label' => $model->fullName];
$this->params['breadcrumbs'][] = $this->title;
$user = $this->context->_user();
$this->registerJs("initStudentForm()");
\yii\widgets\MaskedInputAsset::register($this);
$disabled = !$user->canAccessToResource('science/doctorate-student-passport-edit');
?>
