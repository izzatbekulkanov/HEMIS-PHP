...
$this->title = $model->isNewRecord ? __('Insert Property Publication') : __('Edit Property Publication');
$this->params['breadcrumbs'][] = ['url' => ['science/publication-property'], 'label' => __('Property Publication')];
$this->params['breadcrumbs'][] = ['url' => ['science/publication-property', 'id' => $model->id], 'label' => $model->name];
    ...
    <div class="row">
        <div class="col col-md-12">
            <div class="box box-default ">
                    ...
                    <div class="row">
                        <div class="col col-md-10">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <?= $form->field($model, '_patient_type')->widget(Select2Default::classname(), [
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <?= $form->field($model, 'numbers')->textInput(['maxlength' => true, 'id' => 'keywords']) ?>
                                </div>
                                <div class="col-md-4">
                                    <?= $form->field($model, 'property_date')->widget(DatePickerDefault::classname(), [
                                        'options' => [
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?//= $form->field($model, 'issue_year')->textInput(['maxlength' => true, 'id' => 'issue_year']) ?>
                ...
                <?php if($mainAuthor = EPublicationAuthorMeta::getMainAuthor(EPublicationAuthorMeta::PUBLICATION_TYPE_PROPERTY, $model->id, Yii::$app->user->identity->_employee)):?>
                    <?php if($mainAuthor->_publication_property == $model->id):?>
                        ...
                        <div class="box-body">
                            <?= GridView::widget([
                                ...
                                'dataProvider' => (new EPublicationAuthorMeta())->searchForProperty($model),
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'urlCreator' => function ($action, $model, $key, $index) {
                                            if ($action === 'delete') {
                                                $url = Url::to(['science/publication-property-list', 'id' => $model->id, 'delete' => 1]);
                                                return $url;
                                            }
                                        },
                ...
                <div class="box-footer text-right">
                    <?php if (!$model->isNewRecord && !$model->is_checked): ?>
                        <?= $this->getResourceLink(__('Delete'), ['science/publication-property-edit', 'id' => $model->id, 'delete' => 1], ['class' => 'btn btn-danger btn-flat btn-delete', 'data-pjax' => 0]) ?>
                    <?php endif; ?>
