...
/* @var $searchModel \common\models\archive\EStudentAcademicInformationDataMeta */
...
$this->params['breadcrumbs'][] = ['url' => ['archive/academic-information-data'], 'label' => __('Archive Academic Information Edit')];
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => '_student',
                        'format' => 'raw',
                        'value' => function (EStudentAcademicInformationDataMeta $data) {
                            return Html::a(sprintf('%s<p class="text-muted">%s</p>', $data->student->getFullName(), $data->student->student_id_number), linkTo(['academic-information-data-edit', 'student' => $data->id]), ['data-pjax' => 0]);
                        },
                    ],
                    ...
                    [
                        'format' => 'raw',
                        'value' => function (EStudentAcademicInformationDataMeta $data) {
                            return Html::a(__('Add Academic Information'), linkTo(['academic-information-data-edit', 'student' => $data->id]), ['class' => 'btn btn-default btn-block', 'data-pjax' => 0]);
                        },
                    ],
                ],
            ]); ?>
