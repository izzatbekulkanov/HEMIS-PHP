                ...
                <?= yii2fullcalendar\yii2fullcalendar::widget(array(
                  ...
                  'clientOptions' => [
                   ...
                   'eventClick' => "function(calEvent, jsEvent, view) {
                            ...
                            $.get('exam-schedule-edit',{'id':calEvent.id}, function(data){
                                $('#modal').modal('show')
                                .find('#modalContent')
                                .html(data);
                            })
...
$script = <<< JS
    $(function() {
        $(document).on('click','.fc-day-top', function(){
			...
			var group = $("#_group_search_exam").val();
			
			$.get('exam-schedule-create',{'date':date, 'curriculum':curriculum, 'education_year':education_year, 'semester':semester, 'group':group}, function(data){
				$('#modal').modal('show')
				.find('#modalContent')
				.html(data);
			});
