...
/* @var $searchModel \common\models\performance\EStudentPttMeta */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->params['breadcrumbs'][] = ['url' => ['performance/ptt'], 'label' => __('Performance Ptt Edit')];
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => '_student',
                        'format' => 'raw',
                        'value' => function (EStudentPttMeta $data) {
                            return Html::a(sprintf('%s<p class="text-muted">%s</p>', $data->student->getFullName(), $data->student->student_id_number), linkTo(['ptt-edit', 'student' => $data->id]), ['data-pjax' => 0]);
                        },
                    ],
                    ...
                    [
                        'format' => 'raw',
                        'value' => function (EStudentPttMeta $data) {
                            return Html::a(__('Add Ptt'), linkTo(['ptt-edit', 'student' => $data->id]), ['class' => 'btn btn-default btn-block', 'data-pjax' => 0]);
                        },
                    ],
                ],
            ]); ?>
