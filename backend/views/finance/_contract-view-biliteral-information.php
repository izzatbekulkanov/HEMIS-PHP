...
<section class="invoice">
    ...
    <div class="row">
        <div class="col-xs-12">
            <p class="no-shadow text-justify" style="margin-top: 15px;">
                ...
                Qaror bilan kiritilgan o‘zgartirish va qo‘shimchalarga, Oliy va o‘rta maxsus ta’lim vazirligining 2012 yil
                28 dekabrdagi 508-son buyrug‘i bilan tasdiqlangan, Adliya vazirligida 2013 yil 26 fevralda 2431-son bilan
                davlat ro‘yxatidan o‘tkazilgan “Oliy va o‘rta maxsus, kasb-hunar ta’limi muassasalarida o‘qitishning
                ...
                <b><?= $selected->rector;?></b> bir tomondan, <b><?= $selected->student->fullName;?></b>
                (keyingi o‘rinlarda “Ta’lim oluvchi”) ikkinchi tomondan, birgalikda “Tomonlar” deb ataladigan shaxslar
                mazkur kontraktni quyidagicha tuzdilar:
            </p>
        </div>
        <!-- /.col -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="no-shadow text-justify" style="margin-top: 2px;">
                2.3. Ushbu kontraktning 2.2. bandida ko‘zda tutilgan to‘lov muddatlarini o‘zgartirish, talabalikka tavsiya etilgan abiturientlar uchun - Davlat komissiyasining qarori asosida, ikkinchi va undan yuqori bosqich talabalar uchun - “Ta’lim oluvchi”ning asosli sabablari ko‘rsatilgan holdagi yozma murojaatiga ko‘ra “Ta’lim muassasasi” kengashining qarori asosida qabul qilinadi va bir semestr uchun amal qiladi.
            </div>
        </div>
        <!-- /.col -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <ul>
                ...
                <li>Ta’lim oluvchi o‘qitish uchun belgilangan to‘lov miqdorini to‘laganlik to‘g‘risidagi bank tasdiqnomasi va kontraktning bir nusxasini o‘z vaqtida hujjatlarni rasmiylashtirish uchun ta’lim muassasasiga topshirish.</li>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <ul>
                <li>O‘quv yili uchun kontrakt summasini semestrlarga yoki choraklarga bo‘lmasdan bir yo‘la to‘liqligicha to‘lash mumkin.</li>
                <li>Ta’lim oluvchi  mazkur kontrakt bo‘yicha naqd pul, bank plastik kartasi, bankdagi omonat hisob raqami orqali, ish joyidan arizasiga asosan oylik maoshini o‘tkazishi yoki banklardan ta’lim krediti olish orqali to‘lovni amalga oshirishi mumkin.</li>
