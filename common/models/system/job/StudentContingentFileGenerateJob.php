...
class StudentContingentFileGenerateJob extends BaseObject implements RetryableJobInterface
{
    public $filterParams;
    public $language;
    public $downloadUrl;
    ...
    public function execute($queue)
    {
        ...
        if ($file = EStudentMeta::generateDownloadFile($searchModel->searchContingent($this->filterParams, $this->department, false))) {
