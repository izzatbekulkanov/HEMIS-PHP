...
<div class="wrapper" style="height: auto; min-height: 100%;padding-top: 40px">
    <header class="main-header">
        <nav class="navbar navbar-fixed-top">
            <div class="container">
                <a href="#" class="navbar-brand" id="time_ticker" style="letter-spacing: 1px;font-size: 20px"></a>

                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="<?= linkTo(['education/tasks', 'subject' => $model->subjectTask->_subject]) ?>">
...
<script type="text/javascript">
    ...
    function setTimeTicker() {
        ...
        let leftTime = <?=(time() - $model->started_at->getTimestamp())?>;
        let testTime = <?=$model->subjectTask->test_duration * 60?> - leftTime;
